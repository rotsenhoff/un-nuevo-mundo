...
# función solo existen dentro del ámbito de esa función.
def duplica(num):
    x = num * 2
    return x
...
#---------------------------------------
#Si la definición de una función incluye parámetros, debe proporcionar 
# el mismo número
...
#Puedes pasar los parámetros en el orden que desees, utilizando 
...
# pueden estar vacías, pero si por alguna razón tiene
# una definición de function sin contenido, ingrese la instrucción pass
...
def calcular_total_pago(pago_sin_impuesto,
                        impuesto):
...
pago_con_impuesto = calcular_total_pago(pago_sin_impuesto,
impuesto)
