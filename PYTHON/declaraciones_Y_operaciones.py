...
# COMENTARIOS
# Los comentarios son anotaciones que pondremos en nuestro código que el 
...
# isalum(): Devuelve un boolean, Devuelve verdadero si todos los caracteres 
# de la cadena son numéricos y hay al menos un carácter. 
